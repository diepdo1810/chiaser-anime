...
export function Buttons({ mediaInfo }: { mediaInfo: MangaItem }) {
  return (
    <div className={styles.buttons_container}>
      <Link
        href={`/oread/${mediaInfo.chaptersLatest[0].chapter_api_data.split("/").pop()}?slug=${mediaInfo.slug}`}
      >
        READ NOW
      </Link>
    </div>
