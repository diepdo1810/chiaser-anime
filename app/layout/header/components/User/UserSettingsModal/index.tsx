...
function UserSettingsModal({
  ...
  async function handleUpdateUserInfoForm(
    ...
    localStorage.setItem('lang', form.language.value);
    if (userAnilist) {
  ...
  async function updateLanguageFromDatabase() {
    if (!user && !userAnilist) return;
    ...
    >
      ...
      >
        <div className={styles.settings_heading}>
          <h2>{t("config.Configure Your Account")}</h2>
        ...
        {user?.isAnonymous && (
          <div id={styles.anonymous_disclaimer_container}>
            <h5>{t("config.You are in Anonymous Mode!")}</h5>
            <p>
              <Trans i18nKey="config.In this mode userName">
        ...
        <form onSubmit={(e) => handleUpdateUserInfoForm(e)}>
          <div className={styles.group_container}>
            ...
            {anilistUser && (
              ...
              >
                {t("config.You only may change Username and Photo on")}{" "}
                <a
                  target="_blank"
                  ...
                  <React.Fragment>
                    <label>
                      ...
                      <input
                        ...
                        required
                        title={t("config.Only letters and numbers.")}
                      ></input>
                    </label>

                    {user?.isAnonymous && (
                      <small>
                        <Trans i18nKey="config.Can not change Anonymous">
          ...
          <div className={styles.group_container}>
            ...
            <div>
              ...
              <small>
                <Trans i18nKey="config.Only Aniwatch">
            ...
            <div>
              {currentQuality && (
                <label>
                  <span>
                    {t("config.Preferable Video Quality")}{" "}
                    <span
                      style={{
                        padding: "4px",
              ...
              <small>
                <Trans i18nKey="config.qualityRes1">
                  Some videos <b>may not have the quality selected</b>.
                </Trans>
                {t("config.qualityRes2")}
              </small>
            </div>
              ...
              {currentSkipIntroAndOutro != null && (
                <>
                  <div className={styles.checkbox_container}>
                    ...
                    <p>
                      <Trans i18nKey="config.Skip Aniwatch">
              ...
              {currentNextEpisode != null && (
                <>
                  <div className={styles.checkbox_container}>
                    ...
                    <p>{t("config.Auto Play Next Episode")}</p>
                  </div>
                </>
              )}
            </div>
          ...
          <div className={styles.group_container}>
              ...
              {currentTitleLang && (
                <>
                  ...
                  {userAnilist && (
                    <small>
                      {t(
                        "config.Changing this option will also change on your AniList Account"
                      )}
                    </small>
                  )}
                </>
            ...
            <div>
              {currentSource && (
                <>
                  <label>
                    {t("config.Main Source of Episodes")}
                  ...
                  <small>
                    <Trans i18nKey="config.Focus the anime episodes">
              ...
              {currentShowAdultContent != null && (
                <>
                  <div className={styles.checkbox_container}>
                    ...
                    <p>{t("config.Show Adult Content (+18)")}</p>
                  </div>
              ...
              {currentPlayWrongMediaEnabled != null && (
                <>
                  <div className={styles.checkbox_container}>
                    ...
                    <p>
                      {t("config.Don't show wrong media alert on Watch Page")}
                    </p>
                  </div>
                </>
              )}
            ...
            <div>
              ...
              <div className={styles.btns_container}>
                ...
                <label>
                  ...
                  >
                    {t("config.Delete Episodes Watched")}
                  </motion.button>
                </label>
                <AnimatePresence initial={false} mode="wait">
                  {deleteEpisodesClick && (
                ...
                <label>
                  ...
                  >
                    {t("config.Delete All Account Info")}
                  </motion.button>
                </label>
                <AnimatePresence initial={false} mode="wait">
                  {deleteAccountClick && (
          ...
          >
            {isLoading ? (
              ...
              >
                ...
                {t("config.Changes Complete")}
              </span>
            ) : (
              t("config.Confirm Changes")
            )}
          </motion.button>
        </form>
      </motion.div>
